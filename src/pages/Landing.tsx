      ...
      <section id="videos" className="py-24 px-4 md:px-8 bg-card">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="max-w-3xl mx-auto mb-12">
            <div className="bg-background rounded-2xl overflow-hidden shadow-xl">
              ...
              <div className="p-6">
                ...
                {/* WCAG SC 1.2.1: both clips in this player are silent — they carry
                    no audio track at all — so they are video-only content and need
                    a text alternative describing what is on screen. */}
                <details className="mb-3 text-sm">
                  ...
                  <p className="mt-2 text-muted-foreground">
                    A silent, twelve-second sequence panning across lesson material generated by
                    RealPath Learning. A handout about Pi is shown in two columns side by side, Vietnamese
                    on the left and English on the right, each carrying the same explanation that Pi is the
                    ratio of a circle’s circumference to its diameter, and each with the same labelled
                    diagram and its written description. The view then moves to an authentic assessment
                    built on the same topic, set at a named high school: students analyse circular designs
                    for a courtyard art installation and present to an “Art &amp; Math Connections
                    Committee”, working through process checkpoints that ask them to sketch and label
                    circular shapes and record their thinking as they go.
                  </p>
                </details>
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            ...
            textAlternative: 'A silent screen recording. In the Let’s Get REAL studio, the Assessment tab is opened. Five assessment methods are shown, each rated for how hard it is to fake with AI: Written Assessment (low), Live Performance (high), Process Portfolio (high), Community Connected (very high) and Create & Defend (high). Process Portfolio is chosen, revealing three options tagged Authentic — Revision Portfolio (multi-day), Learning Journal (ongoing) and Video Explanation (a 5 to 10 minute recording). Revision Portfolio is selected and lists what it produces: draft checkpoint prompts, reflection questions and a growth rubric. The recording then moves to the saved assessments page, which holds two 2nd-grade music assessments, and opens one called Music Genres. It shows three learning objectives followed by the generated assessment: process checkpoints that ask students what they heard in classical, jazz and folk examples before any genre is named, with buttons to download it as Word or HTML.'
          }, {
            title: 'Multilingual Support',
            ...
            textAlternative: 'A silent screen recording. In the Let’s Get REAL studio, a rubric is set up for a 2nd-grade music lesson: an assessment description, three learning objectives about reading music notes, four criteria and a K–2 grade level. Under Authentic Learning Mode, authenticity analysis, process documentation and live verification are switched on, and process log and draft history are chosen as the artifacts students must provide. Running the analysis returns a vulnerability score of 54 out of 100, rated high risk: the strengths are that it requires a live presentation and collaboration, and the weaknesses are that the reflection prompts are generic, the output is written only, and the topic is not tied to anywhere specific. Four recommendations follow; one is applied and the analysis runs again. The finished rubric describes four performance levels — Exemplary, Proficient, Developing and Beginning — for how fully a student can answer questions about their own work, and is followed by a teacher-only verification guide listing artifacts to collect before grading and questions to ask afterwards.'
